...
const About = () =>{
    return (
        <div>
            {/* <h1>About</h1> */}
            {/* <div><Header/></div> */}
            <img  className={classes.img} src="https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png"  alt='imagess'></img>
